...
public class GenerateClass {
    ...
    public static void main(String args[]) {
        ...
        classWriter.visit(Opcodes.V1_8,
                ...
                "org/github/caishijun/Comparable", null, "java/lang/Object", new String[]{"org/github/caishijun/Mesurable"});
        ...
        // 使用创建好的class文件
        Class clazz = new MyClassLoader().defineClass("org.github.caishijun.Comparable", data);
        try {
